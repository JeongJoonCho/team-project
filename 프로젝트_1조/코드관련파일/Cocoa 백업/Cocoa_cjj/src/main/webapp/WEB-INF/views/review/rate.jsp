...
<body style="background-color: #FFEBCD">
	...
	<div class="card rcol my-5" style="text-align: center; background-color: #FFEBCD; border: none; width: 80vw; height: 90vh;">
		<form action="${contextPath}/reviewWrite" method="post" id="reviewWrite" enctype="multipart/form-data">
			<table style="width: 50%; margin: 0 auto; border: 1px solid grey; background-color: #FFCC99; color: black;">
				<tr>
				...
				<tr>
					...
					<td style="text-align: left; font-size: 20px;">
						<br> 
						<input type="radio" id="rate" name="rate" value=5> ★ ★ ★ ★ ★ <br>
						<input type="radio" id="rate" name="rate" value=4> ★ ★ ★ ★ <br> 
						<input type="radio" id="rate" name="rate" value=3> ★ ★ ★ <br> 
						<input type="radio" id="rate" name="rate" value=2> ★ ★ <br> 
						<input type="radio" id="rate" name="rate" value=1> ★ <br> 
						<br>
					</td>
				</tr>
				...
				<tr>
					...
					<td style="text-align: left; vertical-align: top;">
						<textarea rows="3" cols="20" class="form-control" id="rContents" name="review"
							style="width: 90%; resize: none; background-color: #FFCC99; border: 1px solid grey; color: black;">${requestInfo.rContents}</textarea>
					</td>
				</tr>
				<tr>
					<td><input type="hidden" name="target" value="${target}">
						...
						<input type="hidden" name="status" value="status4">
					</td>
				</tr>
				<!-- 작성, 취소 -->
				<tr>
					<td align="center" colspan="2">
						<br> 
						<input type="submit" onclick="nullCheck()" id="del" class="btn btn-outline-dark"
						...
						onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
						onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
						value="취 소" onclick="history.back(0)" /> 
						<br> <br>
					</td>
				</tr>
			</table>
