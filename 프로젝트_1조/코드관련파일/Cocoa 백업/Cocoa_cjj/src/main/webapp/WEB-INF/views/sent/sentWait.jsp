				...
				<table style="width: 80%; margin: 0 auto; border: 1px solid grey; background-color: #FFCC99; color: black;">
					...
					<tr>
						...
						<td style="text-align: left;">
							<label class="btn btn-outline-dark" id="findImg" style="background-color: white; color: black;"
								onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
								onmouseout="this.style.color='black'; this.style.backgroundColor='white';" for="file"> 찾아보기 </label>
					...
					<tr>
						...
						<td style="text-align: left;">
							...
							<img id="preview" src="${contextPath}/downRImg?reqNO=${requestInfo.reqNO}" width=95%
							height=300 style="border: 1px solid;" onerror="this.src='resources/image/onerror.png'" />
						</td>
					</tr>
					...
					<tr>
						<td align="center" colspan="2">
							<br> 
							<input type="button" id="mod_start" class="btn btn-outline-dark" style="background-color: white; color: black;"
								onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
								onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
								value="수 정" />
							&nbsp;&nbsp;&nbsp; 
							<input type="submit" id="mod_finish" class="btn btn-outline-dark"
								style="background-color: white; color: black;"
								onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
								onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
								value="확 인" /> 
							<span id="space">&nbsp;&nbsp;&nbsp;</span> 
							<input type="button" id="cancel" class="btn btn-outline-dark"
								style="background-color: white; color: black;"
								onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
								onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
								onclick="reload()" value="취 소" /> 
