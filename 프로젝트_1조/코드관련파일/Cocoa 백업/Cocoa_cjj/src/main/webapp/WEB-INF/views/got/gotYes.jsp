		...
		<form action="${contextPath}/submitReqYes" method="post">
			<table style="width: 80%; margin: 0 auto; border: 1px solid black; background-color: #FFCC99; color: black;">
				...
				<tr>
					...
					<td style="">
						<br> 
						<input type="text" id="" name="rTitle" class="form-control" value="${requestInfo.rTitle}" readonly
				...
				<tr>
					...
					<td style="text-align: left; vertical-align: top;">
						<textarea rows="10" cols="20" class="form-control" id="" name="rContents" readonly
				...
				<tr>
					...
					<td style="">
						<br> 
						<input type="text" id="" name="contact" class="form-control" value="${requestInfo.contact}"
						placeholder="${requestInfo.contact}" style="width: 30%; background-color: #FFCC99; border: 1px solid black; color: black;">
					</td>
				</tr>
				...
				<tr>
					...
					<td style="">
						<input type="number" id="" name="realPrice" class="form-control" value="${requestInfo.realPrice}"
				...
				<tr>
					...
					<td style="">
						<textarea id="" name="reason" rows=3 class="form-control" placeholder="${requestInfo.reason}"
				...
				<tr>
					<td align="center" colspan="2">
						<br> 
						<input type="submit" id="" class="btn btn-outline-dark mt-1" style="background-color: white; color: black;"
							...
							value="재 전 송" />&nbsp;&nbsp;&nbsp; 
						<input type="button" id="" class="btn btn-outline-dark mt-1" style="background-color: white; color: black;"
							onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
							onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
