...
<body style="background-color: #FFEBCD">
	...
	<!-- 타인 프로필 -->
	<form name="proFileInfo" method="post" action="${contextPath}/proFileInfo" enctype="multipart/form-data">
				...
				<div class="row" style="flex-wrap: unset;">
					...
					<div class="col-md-3 col-sm-3 col-xs-12 user-profil-part pull-left">
						<div class="row">
							<div class="col-md-12 col-md-12-sm-12 col-xs-12 user-image text-center"
								...
								<!-- proImg -->
								<br> <br> 
								<img name="proImg" src="${contextPath}/downProfileImg?id=${profileId.id }"
									onerror="this.src='resources/image/onerror.png'" style="border: 1px solid;" width="50%" height="120px"><br>
								<br>
					...
					<div class="card px-3" style="width: 50rem; border: 1px solid; background-color: #FFCC99;">
						<div class="proFile" style="padding: 20px; height: 90vh;">
							...
							<!-- 뒤로가기 -->
							<div style="text-align: center; padding-bottom: 10px; height: 80%;">
