...
<body style="background-color: #FFEBCD">
	...
	<div class="card rcol my-5" style="text-align: center; background-color: #FFEBCD; border: none; width: 80vw; height: 90vh;">
		<table style="width: 80%; margin: 0 auto; border: 1px solid black; background-color: #FFCC99; color: black;">
			<tr>
				<td colspan="2" style="text-align: center; border: 1px solid black; background-color: #CFFFE5;">
					<b>완료한 ${requestInfo.req}의 요청서</b>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="">
				<br> 
					<input type="text" id="rTitle" name="rTitle" class="form-control" value="${requestInfo.rTitle}"
					disabled style="width: 95%; background-color: #FFCC99; border: 1px solid grey; color: black;">
			...
			<tr>
				...
				<td style="float: left;">
					<a href="${contextPath}/downloadGotImg?reqNO=${requestInfo.reqNO}">${requestInfo.rImg}</a><br>
				</td>
			</tr>
			...
			<tr>
				...
				<td style=""><br> <input type="text" id="" name="contact" class="form-control" value="${requestInfo.contact}" disabled
			...
			<tr>
				...
				<td style=""><input type="number" id="" name="realPrice" class="form-control" value="${requestInfo.realPrice}" disabled
					style="width: 30%; background-color: #FFCC99; border: 1px solid black; color: black; float: left;">
					<b style="float: left; padding-top: 7px; margin-left: 3px;">원</b>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="">
					<textarea id="" name="reason" rows=3 disabled class="form-control"
			...
			<tr>
				...
				<br> 
					...
					style="background-color: white; color: black;" onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
					onmouseout="this.style.color='black'; this.style.backgroundColor='white';" onclick="history.back()" value="목록으로" />
				<br> <br></td>
			</tr>
		</table>
	</div>
