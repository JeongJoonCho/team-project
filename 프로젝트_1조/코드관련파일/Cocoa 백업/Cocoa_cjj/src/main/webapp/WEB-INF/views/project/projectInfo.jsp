...
<script type="text/javascript"
	src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=7kuhr3ly8q"></script>
<script type="text/javascript">
...
<body style="background-color: #FFEBCD">
	...
	<!-- 프로젝트 글 구간 -->
	<form method="post" enctype="multipart/form-data" name="frmProject" action="${contextPath}/modProject" id="projectInfo">
		<section class="py-5">
				...
				<div class="col-md-3 col-sm-3 col-xs-12 user-profil-part pull-left">
					<div class="row">
						<div class="col-md-12 col-md-12-sm-12 col-xs-12 user-image text-center"
							...
							<!-- 프로필 조회 이동 -->
							<br> <br> 
							<a href="/cocoa/view_profileInfo?profileId=${projectInfo.leader}">
								<img name="proImg" src="${contextPath}/downProfileImg?id=${projectInfo.leader }"
							...
							<span style="text-align: center;">
								<a href="/cocoa/view_reviewInfo?target=${projectInfo.leader}">
							...
							<!-- kakao -->
							<!-- 본인 검증 -->
							<c:if test="${isLogOn == true && member.id !=projectInfo.leader}">
								<a href="${projectInfo.kakao}"> <input type="button" id="kakaoLink" name="kakaoLink" value="   대화하기   "
									class="btn btn-third-dark" style="text-align: center; border: 1; border-radius: 12px;">
								</a>
							</c:if>
							...
							<div id="mod_kakaoLink">
								<b>카카오톡 오픈채팅 :</b>
								<br> <br> 
								<input type="text" name="kakao" id="mod_kakaoLink" name="kakao" value="${projectInfo.kakao}"
							...
							<c:choose>
								<c:when test="${isLogOn == true && member.id ==projectInfo.leader}">
									<input type="submit" class="btn btn-third-dark" value="수정" id="p_mod"> 
									&nbsp;
					...
					<div class="card px-3" style="width: 50rem; border: 1px solid; background-color: #FFCC99">
						...
						<!-- pImg -->
						<div align="center">
							<input type="hidden" name="originalFileName" value="${projectInfo.pImg }" /> 
							<br> 
							<img id="preview" src="${contextPath}/download?leader=${projectInfo.leader}&pImg=${projectInfo.pImg}&projectNO=${projectInfo.projectNO}"
						...
						<div class="project">
							...
							<!-- memberCount 표시 -->
							인원 : <input name="memberCount" type="number" value="${projectInfo.memberCount}" id="p_pMemberCount" disabled
								style="border: 0; width: 5%; text-align: center; background-color: #FFCC99; font-weight: 700; color: black;">
							<b>명</b>
							<hr>

							<!-- pField 표시 -->
							영역 : <select style="border: 0; text-align: center; width: auto; background-color: #FFCC99; 
									font-weight: 700; color: black;" name="pField" disabled id="p_pField" onchange="categoryChange(this)">
							...
							<!-- level 표시 -->
							등급 : <select style="border: 0; text-align: center; width: auto; background-color: #FFCC99; 
									font-weight: 700; color: black;" name="level" disabled id="p_pLevel">
							...
							<!-- map -->
							&nbsp;모임 장소 
							<input type="text" name="map" id="addr" size="30" value="${projectInfo.map}" disabled> 
							<input type="button" name="send" id="sendMark" value="검색">
							<br> <br>
							...
							<!-- 수정 확인 -->
							<div align="center">
								<input type="submit" onclick="nullCheck()" value="확 인" class="btn btn-outline-dark" id="p_modBtn">
								&nbsp;&nbsp;
