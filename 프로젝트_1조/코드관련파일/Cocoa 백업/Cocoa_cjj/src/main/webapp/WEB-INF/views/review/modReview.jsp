			...
			<div class="row" style="flex-wrap: unset;">
				...
				<div class="col-md-3 col-sm-3 col-xs-12 user-profil-part pull-left">
					<div class="row">
						<div class="col-md-12 col-md-12-sm-12 col-xs-12 user-image text-center"
							...
							<!-- 프로필 조회 이동 -->
							<br> <br> 
							<a href="/cocoa/view_profileInfo?profileId=${reviewVO.target}">
								<img name="proImg" src="${contextPath}/downProfileImg?id=${reviewVO.target}"
							...
							<!-- coach -->
							<input type="text" name="coach" value="${reviewVO.target}" readonly
				...
				<div class="card rcol my-3"
					...
					<form action="${contextPath}" method="post" name="frmReview">
						<table style="width: 80%; margin: 0 auto; border: 1px solid gray; background-color: #FFCC99; color: black;">
							<tr>
								<th colspan="2" style="vertical-align: middle; text-align: center; font-size: 20px;">후기수정</th>
							</tr>
							...
							<tr>
								...
								<td style="text-align: left; vertical-align: top;">
									<textarea rows="3" cols="20" class="form-control" id="rContents" name="review"
										style="width: 95%; resize: none; background-color: #FFCC99; border: 1px solid grey; color: black;">${reviewVO.review}</textarea>
								</td>
							</tr>
							...
							<tr>
								<td>
									<input type="hidden" name="target" value="${reviewVO.target}"> 
									<input type="hidden" name="writer" value="${reviewVO.writer}"> 
							...
							<tr>
								<td align="center" colspan="2">
									<br> 
									<input type="button" id="del" class="btn btn-outline-dark"
